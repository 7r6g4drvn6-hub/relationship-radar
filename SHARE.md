...
1. A 打开小程序，选择“我是 A”，只填写自己的题目。
2. A 在“关系画像”里点“完成我的部分”，复制链接发给 B。
3. B 打开 A 发来的链接，页面会自动带入 A 的结果并切到“我是 B”。
4. B 填完自己的题目后，也可以复制链接发回给 A。
5. 双方结果都在同一页面后，可以复制“双人画像”。
...
所有填写内容只保存在使用者自己的浏览器本地存储里，不会上传到服务器。分享链接会携带当前作答人的必要答案数据，方便对方导入对照。
